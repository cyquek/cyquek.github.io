...
# Notice what happens when you run this command. 
...
# I have updated my suffice in the file names to "fig_nice"
...
# Robbery rate and Per Capita Income
...
###  for PC users (after running stargazer_fix)
stargazer(data, 
          summary.stat = c("n", "mean", "sd", "median", "min", "max"),  
          type="text", title="Descriptive Statistics",
          out="sumstats.txt")
###  for MAC users   
table1df <- data[c("stateid", "vio", "rob","dens","avginc")]
stargazer(table1df, 
          summary.stat = c("n", "mean", "sd", "median", "min", "max"),  
          type="text", title="Descriptive Statistics",
          out="sumstats.txt")
