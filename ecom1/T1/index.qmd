...
Tutorial 1 <br> Introduction to R and RStudio"
format:
  html: 
    grid:
      sidebar-width: 300px
...
Do familiarise yourself with the course syllabus (Subject Guide) [here](https://canvas.lms.unimelb.edu.au/courses/210026/pages/welcome-click-here-to-get-started).
...
The idea behind providing the R script file along with the tutorial questions is to give you a chance to see what various R commands output *before* the tutorial. You should read through the comments provided in the R script file and then run the code "chunk" to see what is output e.g.
